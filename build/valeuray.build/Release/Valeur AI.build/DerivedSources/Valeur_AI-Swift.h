...
#ifndef VALEUR_AI_SWIFT_H
#define VALEUR_AI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Valeur_AI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Valeur_AI11AppDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC9Valeur_AI19SubmitAwareTextView")
@interface SubmitAwareTextView : NSTextView
